...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const linkSide = themeSelectorSidebar.querySelectorAll(`a[data-value="${currentTheme}"]`);
  if (linkSide) link.classList.add("selected");
...
function themeSelections(containerId) {
  console.log("themeSelection function was called")
  ...
  container.querySelectorAll("a").forEach((a) => {
    a.addEventListener("click", (e) => {
      ...
      // Remove 'selected' from all links in this container
      container.querySelectorAll("a").forEach((link) => {
        link.classList.remove("selected");
        console.log(link.textContent + " has been removed");
      });
...
} // Theme & audio handling ending

themeSelections(themeSelectorSidebar)
