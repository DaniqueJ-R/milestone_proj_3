...
// Handles src + label + play for Audio
function setThemeAudio(theme) {
  const audio = document.getElementById("themeAudio");
  const transcript = document.getElementById("themeAudioTranscript");
  let src = "";
  ...
  console.log("Transcript element also:", text);
}
